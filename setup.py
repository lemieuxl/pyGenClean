    ...
    setup(
        ...
        entry_points={
            "console_scripts": [
                ...
                "pyGenClean_compare_bim=PlinkUtils.compare_bim:safe_main",
                "pyGenClean_plot_MDS=PlinkUtils.plot_MDS_standalone:safe_main",
                "pyGenClean_subset_data=PlinkUtils.subset_data:safe_main",
