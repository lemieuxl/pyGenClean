...
5.  One file provided by the
    :py:mod:`pyGenClean.RelatedSamples.find_related_samples` and three files
    provided by :py:mod:`pyGenClean.RelatedSamples.merge_related_samples`:
