...
\author{\begingroup\graphicspath{{\VAR{ logo_dir }}}\includegraphics[width=0.3\textwidth]{\VAR{ logo_path }}\endgroup}
...
used to launch the analysis.\\

Briefly, the clean up procedure was as follow:
\begin{enumerate}

\input{\VAR{ step_filename }}
