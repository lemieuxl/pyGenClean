...
\section{Methods}
The automated script \texttt{pyGenClean} version
\VAR{ pygenclean_version }~\cite{pyGenClean} was used to launch the analysis.
Plink version \VAR{ plink_version }~\cite{plink} was used for the data cleanup
procedure. The following files were used as input.
